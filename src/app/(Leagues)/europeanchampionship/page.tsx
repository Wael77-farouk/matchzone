...
const EuropaLeague = async () => {
  const matches = await filterLeague("UEFA Europa League");
      ...
      <div className="w-full max-w-[800px] mx-auto p-6">
        <div className="bg-slate-900 border border-slate-700 rounded-xl p-8 text-center shadow-lg">
          ...
          <p className="text-slate-400">
            لا توجد مباريات متاحة حالياً للدوري الأوروبي
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="w-full max-w-[800px] mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6">🏆 UEFA Europa League</h1>
